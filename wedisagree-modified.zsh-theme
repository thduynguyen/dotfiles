...
LCHAR_WIDTH=%1G
LCHAR='➤'
PROMPT='%{$fg_bold[yellow]%}%c %{$fg_bold[green]%}%{$LCHAR$LCHAR_WIDTH%} %{$reset_color%}'
...
RPROMPT='$(vi_mode_prompt_info)$(git_prompt_info)%{$reset_color%}$(git_prompt_status)%{$reset_color%}$(git_prompt_ahead)%{$reset_color%}'
